...
# Add more sizes of L1 Cache and L2 Cache   
valid_L1CacheSizes = ['4kB','8kB','32kB','64kB']
valid_L2CacheSizes = ['128kB','256kB','512kB','1MB']

# Add more DRAM
valid_drams = ['DDR3_1600_8x8()', 'DDR3_2133_8x8()', 'LPDDR2_S4_1066_1x32()', 'HBM_1000_4H_1x64()']
# Add more frequencies
valid_frequencies = ['1GHz','2GHz','4GHz']

parser = argparse.ArgumentParser()
parser.add_argument('cpu', choices = valid_cpus.keys())
parser.add_argument('memory_model', choices = valid_memories.keys())
# parser.add_argument('L1cache_size', choices = valid_L1CacheSizes)
# parser.add_argument('L2cache_size', choices = valid_L2CacheSizes)
...
class MySystem(BaseTestSystem):
    ...
    if args.dram_model == 'DDR3_1600_8x8()':
        _DramModel = DDR3_1600_8x8()
        print(_DramModel)
    elif args.dram_model == 'DDR3_2133_8x8()':
        _DramModel = DDR3_2133_8x8()
    elif args.dram_model == 'LPDDR2_S4_1066_1x32()':
        _DramModel = LPDDR2_S4_1066_1x32()
    else:
        _DramModel = HBM_1000_4H_1x64()
    # _L1DCacheSize = args.L1cache_size
    # _L2CacheSize = args.L2cache_size
